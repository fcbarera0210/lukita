  ...
  return (
    <footer className="py-4 px-6 mt-auto">
      <div className="flex items-center justify-center gap-2 flex-wrap sm:flex-nowrap">
        <span className="text-sm text-muted-foreground flex items-center gap-1 whitespace-nowrap sm:text-xs">
          Página desarrollada por{' '}
          <span className="inline-flex items-center font-semibold">
            <span className="text-muted-foreground">charl</span>
            <span className="text-[#00b4b9]">!</span>
            <span className="text-muted-foreground">deas</span>
          </span>
        </span>
        <div className="flex items-center ml-1 sm:flex-shrink-0">
          <svg
            version="1.2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 792 612"
            className="w-8 h-6 block flex-shrink-0 sm:w-6 sm:h-[18px]"
